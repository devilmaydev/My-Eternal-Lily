...
public class TestCharacter : MonoBehaviour
{
    void Start()
    {
        StartCoroutine(PrimeiroAto());
    }

    IEnumerator Test()
    {
        var Spada = CharacterManager.Instance.CreateCharacter("Conor Spada");
        var Alex = CharacterManager.Instance.CreateCharacter("Nano");
        Spada.SetPosition(new Vector2(-0.5f, 1f));
        Spada.Show();
        Alex.SetPosition(new Vector2(2f, 1f));
        Alex.Show();
        yield return Spada.MoveToPosition(new Vector2(0.5f, 1f), 2f, true);
        yield return Spada.Say("Opa!");
        yield return Alex.MoveToPosition(new Vector2(1f, 1f));
    ...
    {
        var Spada = CharacterManager.Instance.CreateCharacter("Conor Spada");
        var Mae = CharacterManager.Instance.CreateCharacter("Mãe");
        var Avo = CharacterManager.Instance.CreateCharacter("Avó");
        var Bona = CharacterManager.Instance.CreateCharacter("Bona");
        var Alex = CharacterManager.Instance.CreateCharacter("Alex");
        var Nano = CharacterManager.Instance.CreateCharacter("Nano");
        var Cliente = CharacterManager.Instance.CreateCharacter("Cliente");
        ...
        yield return Spada.MoveToPosition(new Vector2(0.2f, 0f), 2f, true);
        ...
        Spada.MoveToPosition(new Vector2(0.2f, 0f), 2f, true);
        ...
        yield return DialogueSystem.Instance.Say("narrator", "No dia seguinte em frente a loja.");
        Spada.Show();
        yield return Spada.MoveToPosition(new Vector2(0.5f, 0f));
        ...
        yield return Alex.Say("Humana? Isso porquê eu de fato não sou.");
        ...
        yield return Spada.Say("CINCO MIL!?!? {a}Moço, cê me desculpa mas eu não tenho esse dinheiro não! Eu vou ficar com meu braço antigo mesmo!");
